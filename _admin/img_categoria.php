...
if((isset($_POST["enviado"]))&& ($_POST["enviado"] =="form1")){
		...
		if(file_exists("../img/menu/".$_FILES["userfile"]["name"])){
...
<form class="form-horizontal" name="form1" id="form1" method="post" action="img_categoria.php" enctype="multipart/form-data">
...
<?php 
	...
	move_uploaded_file($_FILES["userfile"]["tmp_name"],"../img/menu/".$nombre_archivo);
	}else{
...
?>
<script>
opener.document.form_cat.img_cat.value="<?php echo $nombre_archivo; ?>";
self.close();
</script>
