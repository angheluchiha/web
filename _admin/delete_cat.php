...
<div class="container">
  <h1 class="text-center">Eliminar categorias </h1>
<div class="table-responsive">
  ...
  <tr>
   ...
   <?php do { ?>
  <tr>
    <td><?php echo $row_DatosCategorias['id_cat']; ?></td>
  ...
  echo "<font color='#195814'> <strong>Activo</strong></font>";
	...
	echo"<font color='#a40d0f'> <strong>Inactivo</strong></font>";
	 ...
	 ?></td>
    <td>
     <a onClick="return confirm('¿Estas seguro(a) de eliminar la categoria <?php echo $row_DatosCategorias['nom_cat']; ?>? \n\n P.D si lo elimina no lo podra recuperar.');" href="delete_cat2.php?delet_ID=<?php echo $row_DatosCategorias['id_cat']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Eliminar </a>
     </td>
   </tr>
