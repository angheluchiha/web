...
(function (factory) {
    ...
    defaultFileActionSettings = {
        ...
        indicatorNewTitle: 'No se ha cargado',
        indicatorSuccessTitle: 'Cargado',
        indicatorErrorTitle: 'Error de carga',
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgInvalidFileType: 'Tipo de archivo invalido "{name}". solo archivos de "{types}" son soportados.',
        msgInvalidFileExtension: 'Extensión invalida del archivo "{name}". Solo se aceptan archivos "{extensions}".',
        msgUploadAborted: 'The file upload was aborted',
        msgValidationError: 'Error al cargar el (los) archivo(s)',
        msgLoading: 'Cargando archivo(s) {index} de {files} &hellip;',
        msgProgress: 'Cargando archivo(s) {index} de {files} - {name} - {percent}% completado.',
